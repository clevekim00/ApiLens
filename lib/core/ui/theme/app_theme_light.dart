    ...
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        hintStyle: baseTextTheme.bodyMedium
            ?.copyWith(color: AppColorsLight.mutedForeground),
        ...
        errorBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(AppTokens.radiusMd),
          borderSide:
              const BorderSide(color: AppColorsLight.destructive, width: 1),
        ),
      ),
      tabBarTheme: TabBarThemeData(
        ...
        dividerColor: AppColorsLight.border,
        labelStyle: AppTokens.textTheme.bodyMedium
      ...
      scrollbarTheme: ScrollbarThemeData(
        ...
        thumbColor: WidgetStateProperty.resolveWith((states) {
          ...
          return AppColorsLight.mutedForeground.withValues(alpha: 0.5);
        }),
      ),
