          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                _buildDraggableItem(context, ref, 'WS Send', 'ws_send', Icons.send, Colors.purpleAccent),
                _buildDraggableItem(context, ref, 'WS Wait', 'ws_wait', Icons.hourglass_top, Colors.deepPurple),
              ],
            ),
          ),
        ],
