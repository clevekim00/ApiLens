...
class EdgePathUtil {
  static Path createEdgePath(
      WorkflowEdge edge, WorkflowNode source, WorkflowNode target) {
    double sourceOffsetY = 40;
    if (edge.sourcePort == 'true' || edge.sourcePort == 'success') {
      sourceOffsetY = 20;
    }
    if (edge.sourcePort == 'false' || edge.sourcePort == 'failure') {
      sourceOffsetY = 60;
    }
  ...
  static bool isPointNearPath(Path path, Offset point,
