        ...
        data: (list) {
          ...
          return Row(
            children: [
                    ...
                    Expanded(
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final isSelected =
                              ref.watch(activeEnvironmentIdProvider) == item.id;
                          return ListTile(
                            ...
                            onTap: () {
                              ...
                              ref.read(_editingEnvIdProvider.notifier).state =
                                  item.id;
                            },
                            leading: RadioGroup<Id?>(
                              groupValue:
              ...
              const Expanded(
                flex: 7,
                child: _EnvironmentDetailEditor(),
              ),
            ],
          );
        },
...
class _EnvironmentDetailEditor extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<_EnvironmentDetailEditor> createState() =>
      _EnvironmentDetailEditorState();
}

class _EnvironmentDetailEditorState
    extends ConsumerState<_EnvironmentDetailEditor> {
  ...
  void _save() {
    ...
    ref
        .read(environmentListProvider.notifier)
        .updateEnvironment(_currentId!, _currentName, varMap);
      ...
      child: Column(
        ...
        children: [
          TextFormField(
            ...
            onChanged: (v) =>
                _currentName = v, // Only save to local var until Save clicked
          ),
          const SizedBox(height: 16),
