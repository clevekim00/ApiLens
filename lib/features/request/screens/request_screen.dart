...
import '../../../../features/websocket/presentation/widgets/websocket_client_panel.dart'; // Add Import
...
class _RequestScreenState extends ConsumerState<RequestScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Using DefaultTabController for HTTP vs WebSocket
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              actions: [
                IconButton(
                  ...
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (_) => WorkflowEditorScreen()));
                  },
                ),
                const EnvironmentSelector(),
                const SizedBox(width: 16),
                 // Send Button - Visible mainly for HTTP but kept shared for now (disabled in WS logic conceptually)
                 Padding(
                 ...
                 PopupMenuButton<String>(
                   onSelected: (val) {
                     if (val == 'workflow') Navigator.push(context, MaterialPageRoute(builder: (_) => WorkflowEditorScreen()));
            ...
            body: TabBarView(
              children: [
                ...
                // Tab 2: WebSocket Client (Embedded)
