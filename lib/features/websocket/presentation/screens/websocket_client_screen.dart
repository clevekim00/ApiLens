...
class WebSocketClientScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<WebSocketClientScreen> createState() =>
      _WebSocketClientScreenState();
}
                        ...
                        return ListTile(
                          ...
                          trailing: PopupMenuButton(
                            ...
                            onSelected: (value) async {
                              if (value == 'delete') {
                                await ref
                                    .read(webSocketConfigRepositoryProvider)
                                    .delete(config.id);
                                ref.invalidate(websocketConfigsProvider);
          ...
          FilledButton(
            onPressed: () async {
              if (nameCtrl.text.isNotEmpty && urlCtrl.text.isNotEmpty) {
                await ref
                    .read(webSocketConfigRepositoryProvider)
                    .saveNew(name: nameCtrl.text, url: urlCtrl.text);
                ref.invalidate(websocketConfigsProvider);
...
final websocketConfigsProvider =
    FutureProvider<List<WebSocketConfig>>((ref) async {
