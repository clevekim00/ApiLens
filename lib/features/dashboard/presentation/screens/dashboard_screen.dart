          ...
          builder: (context, constraints) {
            if (constraints.maxWidth > 800) {
              return Row(
                children: [
                  Expanded(
                      child: _buildPerformanceItem(context, 'Checkout API',
                          '112ms', '99.1%', Colors.green)),
                  const SizedBox(width: AppTokens.s4),
                  Expanded(
                      child: _buildPerformanceItem(context, 'Payment-Init',
                          '155ms', '97.9%', Colors.orange)),
                  const SizedBox(width: AppTokens.s4),
                  Expanded(
                      child: _buildPerformanceItem(
                          context, 'User-Auth', '98ms', '99.8%', Colors.green)),
                ],
              );
            } else {
              return Column(
                children: [
                  _buildPerformanceItem(
                      context, 'Checkout API', '112ms', '99.1%', Colors.green),
                  const SizedBox(height: AppTokens.s4),
                  _buildPerformanceItem(
                      context, 'Payment-Init', '155ms', '97.9%', Colors.orange),
                  const SizedBox(height: AppTokens.s4),
                  _buildPerformanceItem(
                      context, 'User-Auth', '98ms', '99.8%', Colors.green),
                ],
